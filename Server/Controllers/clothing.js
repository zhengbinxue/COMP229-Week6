...
function DisplayClothingListPage(req, res, next) {
    clothing_1.default.find((err, clothingCollection) => {
        ...
        res.render('index', { title: 'Clothing List', page: 'clothing-list', clothing: clothingCollection, displayName: (0, Util_1.UserDisplayName)(req) });
    });
}
...
function DisplayEditPage(req, res, next) {
    ...
    clothing_1.default.findById(id, {}, {}, (err, clothingItemToEdit) => {
        ...
        res.render('index', { title: 'Edit', page: 'update', clothing: clothingItemToEdit, displayName: (0, Util_1.UserDisplayName)(req) });
    });
}
exports.DisplayEditPage = DisplayEditPage;
function DisplayAddPage(req, res, next) {
    res.render('index', { title: 'Add', page: 'update', clothing: '', displayName: (0, Util_1.UserDisplayName)(req) });
}
